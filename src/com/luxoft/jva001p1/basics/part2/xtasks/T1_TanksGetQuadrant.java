...
public class T1_TanksGetQuadrant extends JPanel
{
    ...
    void runTheGame() throws Exception
    {
        ...
        callGetTankQuadrant(4 * 64 + 10, 7 * 64 + 10);
    }
    ...
    String getTankQuadrant(int x, int y)
    {
        ...
        //return (char)(x/64+'a')+"_"+(y/64+1);

        char xChar = xCoordinates.charAt(x/64);
        int yNum = y/64+1;
        return xChar+"_"+yNum;
    }
    ...
    public T1_TanksGetQuadrant() throws Exception
    {
        ...
        frame.setMinimumSize(new Dimension(BF_WIDTH+22, BF_HEIGHT + 22+22));
