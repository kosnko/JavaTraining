...
//    int msDelay = 2;
    ...
    void runTheGame() throws Exception
    {
        ...
        {
//            callNum++;
//            turn((Integer.MAX_VALUE/callNum + Integer.MAX_VALUE*tankDirection) % 5);
//            fire();
//            //move(tankDirection);
...
//        int xIdx = bulletX/64;
//        int yIdx = bulletY/64;
        //System.out.println(quadrant[0]+" "+quadrant[1]);
    ...
    void bulletmove()
    {
        ...
        while (i < 14)
        {
            if(tankDirection == 1 && bulletY != 0)
            {
                bulletY -=step;
            }
            else if(tankDirection == 2 && bulletX != BF_WIDTH - 14)
            {
                bulletX +=step;
            }
            else if(tankDirection == 3 && bulletY != BF_HEIGHT - 14)
            {
                bulletY +=step;
            }
            else if(tankDirection == 4 && bulletX != 0)
            {
                bulletX -=step;
            }
            else
            ...
            if ( bulletY % 64 == 0 || bulletX % 64 == 0 ) // should move on brick completely
            {
                i = 0;
                if(tankDirection == 2 || tankDirection == 3) // already on brick completely
                {
                    break;
                }
            }
