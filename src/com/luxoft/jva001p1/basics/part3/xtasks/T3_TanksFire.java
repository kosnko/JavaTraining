...
//        bulletY = tankY;
        ...
        for (int dir: directions) {
            ...
            if (dir == 1) {
                ...
                bulletX = tankX+64;
                bulletY = tankY+32-7;
                while (bulletX < BF_WIDTH - 64) {
                    move(dir);
                }
            } else if (dir == 3) {
                bulletX = tankX+32-7;
                bulletY = tankY+64;
                while (bulletY < BF_HEIGHT-64) {
                    move(dir);
                }
            } else if (dir == 4) {
                bulletX = tankX;
    ...
    void move(int direction)
    {
        ...
        while (i < 64)
        {
            if(direction == 1 && bulletY != 0)
            {
                bulletY -=step;
            }
            else if(direction == 2 && bulletX != BF_WIDTH - 64)
            {
                bulletX +=step;
            }
            else if(direction == 3 && bulletY != BF_HEIGHT - 64)
            {
                bulletY +=step;
            }
            else if(direction == 4 && bulletX != 0)
            {
                bulletX -=step;
            }
            else
